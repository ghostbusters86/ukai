        ...
        <div class="col-lg-6 col-md-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="col">
                <a>Benar: <br> <i class="fa fa-check"><span>96</span></i></a>
              </div>
              <div class="col">
                <a>Salah: <br> <i class="fa fa-times"> <span>4</span></i></a>
              </div>
              <div class="col">
                <a>Skor: <br> <i class="fa fa-trophy"> <span>96</span></i></a>
              </div>
              </div>
            </div>
          </div>
          <div class="card">
            ...
            <div class="card-body">
              <div class="wrap-soal">
                ...
                <br>
                <p class="nomor">Kunci: <span style="color: #777">B</span></p>
                <p class="nomor">Penjelasan:</p>
                <p class="description-soal">Apoteker di industri farmasi akan melakukan sebuah pembelian mesin cetak tablet. Ketika mesin datang ke industri tersebut, dilakukan kualifikasi untuk melihat bagaimana kinerja mesin pertama kali sesuai standar.</p>
              </div>
            </div>
          </div>
