				...
				<div class="card">
					<div class="card-body">   
						...
						<div class="form-group">
							...
							<select class="custom-select form-control" name="jk_user">
						...
						<div class="form-group">
							...
							<input type="number" class="form-control" placeholder="Masukkan No Telepoone Anda" name="nohp_user">
						</div>
						<div class="form-group">
							<label>Universitas</label>
							<input type="text" class="form-control" placeholder="Masukkan Nama Universitas Anda" name="universitas_user">
						</div>
					</div>
				</div>  
			</div>
					...
					<div class="card-body">   
						...
						<div class="form-group">
							...
							<select class="custom-select form-control	" name="akses_level">
								<option selected>Pilih jenis Akses Level Anda</option>
