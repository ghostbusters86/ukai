...
class Reset_password extends CI_Controller {
	...
	public function index()
	{
		...
		if($this->form_validation->run() == FALSE) {  
			...
			if(!$userInfo){  
				$this->session->set_flashdata('notifikasi', '<div class="alert alert-danger alert-dismissible fade show"><center>Email Yang Anda masukan tidak terdaftar <strong> Anda</strong></center><button type="button" class=close data-dismiss=alert aria-label=Close>
